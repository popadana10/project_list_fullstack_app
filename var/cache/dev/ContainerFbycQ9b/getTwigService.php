...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \Pentatrion\ViteBundle\Twig\EntryFilesTwigExtension(($container->privates['pentatrion_vite.entrypoint_renderer'] ?? $container->load('getPentatrionVite_EntrypointRendererService'))));
